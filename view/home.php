...
<div id="sidenav" class="sidenav">
    ...
    <a href="connection"><li class="active">Login</li></a>
...
<div class="container" id="container">
    ...
    <div class="container__lists">
        <ul class="container__list container__list--items"> 
            ...
            action="index.php?uc=admin&action=update&id=<?= $user['id']; ?>" method='post'>
            ...
            <ul class="container__list">                                        
                <li class="list__item "> 
                    ...
                    href="index.php?uc=admin&action=delete&id=<?= $user['id']; ?>">     
    ...
    <section class="container__modal ">
        <a class="link__add" href="#formulaire" title="add a simple user">Add an user</a>
            <form  class="add__form display-none container__list--items" 
            action="index.php?uc=admin&action=createUser" method="post">
